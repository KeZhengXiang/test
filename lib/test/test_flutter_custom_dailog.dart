...
import 'dialog/listview_dialog.dart';
import 'dialog/notice_dialog.dart';
import 'dialog/progress_dialog.dart';

void main() => runApp(TestFlutterCustomDailogApp());

var titleTextStyle = TextStyle(fontSize: 22, color: Colors.black);

class TestFlutterCustomDailogApp extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
    return MaterialApp(
      home: TestFlutterCustomDailog(),
    );
  }
}
 ...
 */
class TestFlutterCustomDailog extends StatelessWidget {
  Widget build(BuildContext context) {
    //1、初始化context
