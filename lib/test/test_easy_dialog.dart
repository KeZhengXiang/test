...
//class TestEasyDialog1 extends StatelessWidget {
//  @override
...
//      ),
//      home: TestEasyDialog(title: 'Easy Dialog Examples'),
//    );
//  }
//}

class TestEasyDialog extends StatefulWidget {
  TestEasyDialog({Key key, this.title = "Easy Dialog Examples"}) : super(key: key);

  final String title;

  @override
  _TestEasyDialogState createState() => _TestEasyDialogState();
}

class _TestEasyDialogState extends State<TestEasyDialog> {
  ...
  void _basicImageEasyDialog() {
    EasyDialog(
      ...
      topImage: NetworkImage(
          "http://cms-bucket.ws.126.net/2020/0517/22e24e11j00qaga5u0043c000s600e3c.jpg"),
      height: 280,
    ).show(context);
  }
